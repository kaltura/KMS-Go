...
class Login(Base):
    ...
    def click_login_button(self):
        if self.click(self.login.login_button) == True:
            ...
            logger.infoLog('WARNING: Function: "' + sys._getframe().f_code.co_name + '" - Failed to click on login button')
    ...
    def click_signin_button(self):
        if self.click(self.login.signin_button) == True:
            ...
            logger.infoLog('WARNING: Function: "' + sys._getframe().f_code.co_name + '" - Failed to click on signin button')
            return False        
    ...
    def click_coordinates_login_frame(self, x, y):
        if self.click_with_offset(self.login.login_frame, x, y) == True:
            ...
            logger.infoLog('WARNING: Function: "' + sys._getframe().f_code.co_name + '" - Failed to click with coordinates on login frame: x,y:' + str(x) + ',' + str(y))
            return False
    ...
    def wait_for_logged_in_background(self, timeout):
        if self.wait_visible(self.login.logged_in_background, timeout) != None:
            ...
            logger.infoLog('WARNING: Function: "' + sys._getframe().f_code.co_name + '" - Element logged_in_background doesn\'t appear after ' + str(timeout))
            return False   
    ...
    def type_login_username(self, text):
        if self.send_keys(self.login.text_login_username, text)  == True:
            ...
            logger.infoLog('WARNING: Function: "' + sys._getframe().f_code.co_name + '" - Failed to type in login username filed: "' + text + '"')
            return False          
    ...
    def type_login_password(self, text):
        if self.send_keys(self.login.text_login_password, text)  == True:
            ...
            logger.infoLog('WARNING: Function: "' + sys._getframe().f_code.co_name + '" - Failed to type in login password filed: "' + text + '"')
            return False
