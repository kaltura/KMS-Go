...
class Screen:
        ...
        if type(values) is str:
            ...
            for value in values:
                try:
                    ...
                    pass
            logger.debugLog('Function: ' + sys._getframe().f_code.co_name + ': Element not found by: "' + method + '" = "' + values + '"')
            raise NoSuchElementException
    ...
    def get_element_by_type(self, method, value):
        if method == 'accessibility_id':
            ...
            logger.debugLog('Function: ' + sys._getframe().f_code.co_name + ': Invalid locator method: "' + method + '" = "' + value + '"')
    ...
    def get_elements_by_type(self, method, value):
        if method == 'accessibility_id':
            ...
            logger.debugLog('Function: ' + sys._getframe().f_code.co_name + ': Element not found by: "' + method + '" = "' + value + '"')
            raise Exception('Invalid locator method.')
